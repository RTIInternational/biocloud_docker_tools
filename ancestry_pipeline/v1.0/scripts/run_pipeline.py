...
while next_step['step'] != 'exit' and next_step['step'] != 'error':
    # Create directories for step
    step_working_dir = "{}{}".format(wf_vars['inputs.working_dir'], next_step['step'])
    os.system("mkdir -p {}".format(step_working_dir))
    step_output_dir = "{}{}".format(wf_vars['inputs.output_dir'], next_step['step'])
    os.system("mkdir -p {}".format(step_output_dir))
    # Set task inputs
    ...
    # Open log file
    step_log = "{}/{}.log".format(step_output_dir, next_step['step'])
