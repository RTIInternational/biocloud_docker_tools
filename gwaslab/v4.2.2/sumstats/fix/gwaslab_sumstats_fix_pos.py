...
def main():
    parser = argparse.ArgumentParser(
        description="Standardize and validate genomic base-pair positions in GWASLab.",
    ...
    parser.add_argument("--remove", action="store_true", default=False, help="Remove records with invalid positions.")
    parser.add_argument("--lower_limit", type=int, default=0, help="Minimum acceptable genomic position.")
    parser.add_argument("--limit", type=int, default=250000000, help="Maximum acceptable genomic position.")
    ...
    try:
        ...
        print(f"Successfully fixed positions and saved to {args.out}")
    except Exception as e:
        print(f"Error in fix_pos: {e}", file=sys.stderr)
        sys.exit(1)
