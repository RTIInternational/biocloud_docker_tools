#!/usr/bin/env python3
"""
GWASLab Sumstats Core: flip_allele_stats
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Adjust statistics and allele directions based on STATUS codes in GWASLab.",
    ...
    try:
        ...
        print(f"Successfully flipped allele stats and saved to {args.out}")
    except Exception as e:
        print(f"Error in flip_allele_stats: {e}", file=sys.stderr)
        sys.exit(1)
