#!/usr/bin/env python3
"""
GWASLab Sumstats Core: sort_column
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Reorder summary statistics columns according to standard GWAS order in GWASLab.",
    ...
    try:
        ...
        print(f"Successfully sorted columns and saved to {args.out}")
    except Exception as e:
        print(f"Error in sort_column: {e}", file=sys.stderr)
        sys.exit(1)
