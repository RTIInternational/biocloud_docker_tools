#!/usr/bin/env python3
"""
GWASLab Sumstats Core: infer_build & set_build
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Infer genome build using HapMap3 SNPs in GWASLab.",
    ...
    try:
        ...
        print(f"Inferred build: {mysumstats.build}, saved to {args.out}")
    except Exception as e:
        print(f"Error in infer_build: {e}", file=sys.stderr)
        sys.exit(1)
