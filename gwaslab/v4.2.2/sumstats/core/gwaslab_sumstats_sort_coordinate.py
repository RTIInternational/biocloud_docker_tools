#!/usr/bin/env python3
"""
GWASLab Sumstats Core: sort_coordinate & sort_column
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Sort summary statistics by genomic coordinates (CHR, then POS) using GWASLab.",
    ...
    try:
        ...
        print(f"Successfully sorted by coordinate and saved to {args.out}")
    except Exception as e:
        print(f"Error in sort_coordinate: {e}", file=sys.stderr)
        sys.exit(1)
